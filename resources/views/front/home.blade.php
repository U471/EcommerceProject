...
<div class="span9">		
		...
		<h4>Latest Products </h4>
			  ...
			  @foreach($newProducts as $products)
				<li class="span3">
				  <div class="thumbnail">
					<a  href="{{route('productView',$products->id)}}"><img src="{{asset('upload/'.$products->image)}}" alt=""/></a>
					<div class="caption">
					  <h5>{{$products->name}}</h5>
					   <h4 style="text-align:center"><a class="btn" href="{{route('productView',$products->id)}}">
						    <i class="icon-zoom-in"></i></a>
							 <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a>
							  <a class="btn btn-primary" href="#">{{$products->price}}</a></h4>
					</div>
				  </div>
				</li>
				@endforeach
